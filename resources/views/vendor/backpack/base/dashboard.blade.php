...
@php
    ...
    'content' => [
            [
                'type'          => 'progress_white',
                'class'         => 'card mb-2',
                'value'         =>  '<span class="text-success">' . NotificationRepositoryEloquent::sum(\App\Domain\Contracts\Contract::PRICE,[\App\Domain\Contracts\Contract::IS_PAID=>true]) . ' KZT</span>',
                'description'   => 'Сумма всех оплат',
                'progress'      => 100, // integer
                'progressClass' => 'progress-bar bg-success',
                'hint'          => NotificationRepositoryEloquent::sumLastMonth(\App\Domain\Contracts\Contract::PRICE,[\App\Domain\Contracts\Contract::IS_PAID=>true]) . ' KZT Сумма за последний 30 дней',
            ],
        ],
    ];
@endphp
