...
@php
    ...
    $questions  =   NotificationRepositoryEloquent::_getByUserId($url[2]);
@endphp
                        ...
                        <td class="fsize">
                            @if($lawyer)
                                @if ($lawyer->{Contract::ROLE} === Contract::LAWYER)
                                    <a href="/lawyer/{{ $lawyer->{Contract::ID} }}/show" class="text-info"><u>{{ $lawyer->{Contract::NAME} }} {{ $lawyer->{Contract::SURNAME} }}</u></a>
                                @elseif ($lawyer->{Contract::ROLE} === Contract::ADMIN)
                                    <a href="/admin/{{ $lawyer->{Contract::ID} }}/show" class="text-info"><u>{{ $lawyer->{Contract::NAME} }} {{ $lawyer->{Contract::SURNAME} }}</u></a>
                                @elseif ($lawyer->{Contract::ROLE} === Contract::USER)
                                    <a href="/user/{{ $lawyer->{Contract::ID} }}/show" class="text-info"><u>{{ $lawyer->{Contract::NAME} }} {{ $lawyer->{Contract::SURNAME} }}</u></a>
                                @endif
                            @endif
                        </td>
                    </tr>
