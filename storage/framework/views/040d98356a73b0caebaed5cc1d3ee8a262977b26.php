    ...
    <?php if($endpoint->metadata->authenticated && $metadata['auth']['location'] === 'header'): ?>
        <p>
            <label id="auth-<?php echo e($endpoint->endpointId()); ?>" hidden><?php echo e($metadata['auth']['name']); ?> header:
                <b><code><?php echo e($metadata['auth']['prefix']); ?></code></b>
                <input type="text"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'scribe::components.nested-fields','data' => ['fields' => $endpoint->nestedBodyParameters,'endpointId' => $endpoint->endpointId()]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php if(count($endpoint->responseFields)): ?>
    ...
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'scribe::components.nested-fields','data' => ['fields' => $endpoint->nestedResponseFields,'endpointId' => $endpoint->endpointId(),'isInput' => false]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('scribe::nested-fields'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Projects\needhelp\vendor\knuckleswtf\scribe\src/../resources/views//themes/default/endpoint.blade.php ENDPATH**/ ?>